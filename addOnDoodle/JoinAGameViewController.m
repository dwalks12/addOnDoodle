    ...
    [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        if(!error){
            ...
            if(yourPlaying == NO){
                ...
                self.gameArray = [[NSArray alloc]init];
                ...
                if(attempts <= 10){
                    ...
                    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Sorry!"
                                                                                   message:@"There are no available matches at this moment. Please try again later."
...
-(void)takeSnapShot{
    ...
    NSMutableArray *userArray = [[NSMutableArray alloc]initWithArray:[self.gameArray[0] valueForKey:@"usersInvolved"]];
