//
//  PlayerAndPlayerViewController.m
//  addOnDoodle
//
//  Created by Dawson on 08/10/15.
...
@interface PlayerAndPlayerViewController ()<ACEDrawingViewDelegate,UIScrollViewDelegate,STADelegateProtocol>
...
@end
@implementation PlayerAndPlayerViewController{
    int attempts;
...
-(void)backToMain{
    PlayWithFriendViewController *playWithFriend = [PlayWithFriendViewController new];
    UIViewAnimationTransition trans = UIViewAnimationTransitionCurlUp;
    [UIView beginAnimations: nil context: nil];
    [UIView setAnimationDuration:1.0];
    [UIView setAnimationTransition: trans forView: [self.view window] cache: YES];
    [self presentViewController:playWithFriend animated:NO completion:nil];
...
-(void)takeSnapShot{
    ...
    [userArray addObject:appDelegate.friendsName];
    NSArray *userArrayCopy = [NSArray arrayWithArray:userArray];
    NSNumber *chainLength = @1;
    
    NSString *whoseTurn = appDelegate.friendsName;
    
    PFObject *object = [PFObject objectWithClassName:@"GameWithFriend"];
    [userArray addObject:whoseTurn];
    [object setObject:userArrayCopy forKey:@"usersInvolved"];
    [object setObject:imageArrayCopy forKey:@"imagesArray"];
    [object setObject:whoseTurn forKey:@"whoseTurn"];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.text = @"Friendly Game";
